...
\previousversion[https://www.ivoa.net/documents/DocRegExt/20251102]{PR-1.0-20251102}
...
standard VO\-Re\-source relationships covers this use case).
...
To satisfy the requirements derived above, we have designed a registry
extension.  The namespace URI for this schema is
$$\hbox{\nolinkurl{http://www.ivoa.net/xml/DocRegExt/v1}}$$
The schema file can be retrieved from this URI.
...
\subsection{Changes from PR-1.0-20251102}

\begin{itemize}
\item Recommending the usage of ASCL identifiers to declare
relationships to software.
\item New interface type StaticFile; this lets publishers declare
media types of single files.
\end{itemize}
